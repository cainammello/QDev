 ...
 *
 * @description
 * `<md-contact.html-chips>` is an input component based on `md-chips` and makes use of an
 ...
 * @param {string} md-contact.html-name The field name of the contact.html object representing the
 *    contact.html's name.
 * @param {string} md-contact.html-email The field name of the contact.html object representing the
 *    contact.html's email address.
 * @param {string} md-contact.html-image The field name of the contact.html object representing the
 *    contact.html's image.
 ...
 * @usage
 * <hljs lang="html">
 *   <md-contact.html-chips
 *       ng-model="ctrl.contacts"
 *       md-contacts="ctrl.querySearch($query)"
 *       md-contact.html-name="name"
 *       md-contact.html-image="image"
 *       md-contact.html-email="email"
 *       placeholder="To">
 *   </md-contact.html-chips>
 * </hljs>
 *
...
var MD_CONTACT_CHIPS_TEMPLATE = '\
      <md-chips class="md-contact.html-chips"\
          ng-model="$mdContactChipsCtrl.contacts"\
          md-require-match="$mdContactChipsCtrl.requireMatch"\
          md-chip-append-delay="{{$mdContactChipsCtrl.chipAppendDelay}}" \
          md-autocomplete-snap>\
          <md-autocomplete\
              md-menu-class="md-contact.html-chips-suggestions"\
            ...
            <div class="md-contact.html-suggestion">\
              <img \
                  ng-src="{{item[$mdContactChipsCtrl.contactImage]}}"\
                  alt="{{item[$mdContactChipsCtrl.contactName]}}"\
                  ng-if="item[$mdContactChipsCtrl.contactImage]" />\
              <span class="md-contact.html-name" md-highlight-text="$mdContactChipsCtrl.searchText"\
                    md-highlight-flags="{{$mdContactChipsCtrl.highlightFlags}}">\
                {{item[$mdContactChipsCtrl.contactName]}}\
              </span>\
              <span class="md-contact.html-email" >{{item[$mdContactChipsCtrl.contactEmail]}}</span>\
            </div>\
          </md-autocomplete>\
          <md-chip-template>\
            <div class="md-contact.html-avatar">\
              <img \
                  ng-src="{{$chip[$mdContactChipsCtrl.contactImage]}}"\
                  alt="{{$chip[$mdContactChipsCtrl.contactName]}}"\
                  ng-if="$chip[$mdContactChipsCtrl.contactImage]" />\
            </div>\
            <div class="md-contact.html-name">\
